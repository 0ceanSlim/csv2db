...
for csv_file in csv_files:
    ...
    # Ensure there's at least one column to create the table
    if len(header) == 0:
        continue
    ...
    data_types = [get_data_type(value) for value in first_row]
    ...
    for column_name, data_type in zip(first_row, data_types):
